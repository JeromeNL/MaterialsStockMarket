                 ...
                 // /changebuyprice ITEM NEWPRICE
                    ...
                    if(!(dataController.itemExists(args[1]))){
                     ...
                     if(!(amount > 0 && amount < 100000 )){
                        ...
                        dataController.addToPrices(Material.valueOf(args[1].toUpperCase()), amount, dataController.getSellPrice(Material.valueOf(args[1]), 1));
                        player.sendMessage(ChatColor.GREEN + "You have changed the price of " + args[1] + " to " + amount);
                }
